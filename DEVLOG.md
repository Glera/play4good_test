...
### Что сделано
Увеличен бонус за победу с 1000 до 1500 очков. Добавлен эмодзи трофея к сообщению о победе ('YOU WIN!' → 'YOU WIN! 🏆'). Минорное изменение для проверки полного CI pipeline.
...
```bash
git cherry-pick 09f331eb8b5cf4a21937962ee70ec81598ba5a1e
```
