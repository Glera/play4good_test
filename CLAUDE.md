...
- FPS: > 30
- Memory growth over 10s: < 5 MB

Если изменение ломает бюджет — Claude автоматически пытается оптимизировать.
Бюджеты НЕ должны ослабляться — код должен быть оптимизирован.
